...
const [isDescModalOpen, setIsDescModalOpen] = useState(false);
  ...
  const handleTextareaClick = () => {
    setModalContent(announcementDesc);
    setIsDescModalOpen(true);
  };

  const handleTitleClick = () => {
    setModalTitle(announcementTitle);
    setIsTitleModalOpen(true);
  };


  const handleDescSave = () => {
    setAnnouncementDesc(modalContent);
    setIsDescModalOpen(false);
  };

  const handleTitleSave = () => {
    setAnnouncementTitle(modalTitle);
          ...
          <main className="grid gap-4 p-4 md:gap-8 md:p-10">
            <div className="grid gap-2">
              <h1 className="font-semibold text-lg">
                Following is the List of Announcement Done
              </h1>
            </div>
            <div className="grid gap-4">
              <div className="border rounded-lg shadow-xl">
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      <TableCell>New Announcement</TableCell>
                      <TableCell>
                        <input
                          type="text"
                      ...
                      {isTitleModalOpen && (
                        <div className="fixed inset-0 flex items-center justify-center z-50 bg-gray-900 bg-opacity-75 ">
                          <div className="bg-gray-200 dark:bg-slate-950 py-3 px-2 rounded-md w-3/4">
                            <input
                              type="text"
                              value={modalTitle}
                      ...
                      <TableCell>
                        <Button
                          className="bg-[#1e1b4b] dark:text-white hover:bg-slate-600 dark:hover:text-slate-800"
                          onClick={() =>
                            addContent(
                              "announcements",
                              {
                      ...
                      <TableRow key={item.id}>
                        ...
                        <TableCell>
                          <Button
                            className="bg-[#1e1b4b] dark:text-white hover:bg-slate-600 dark:hover:text-slate-800"
                            onClick={() =>
                              deleteContent("announcements", item.id)
                            }
                          >
                            Delete
                          </Button>
...
export default MentorProjectAnn;
