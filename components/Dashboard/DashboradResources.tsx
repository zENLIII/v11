              ...
              <div className="mx-auto max-w-7xl w-full flex flex-col min-h-screen">
                <header className="flex justify-center items-center gap-4 px-4 md:px-6">
                  <div className="space-y-1">
                    <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none text-black dark:text-white [text-shadow:_0_1px_0_rgb(0_0_0_/_40%)]">
                      Resources
                    </h1>
                  </div>
                </header>
                <div className="mt-10 mx-auto grid max-w-4xl gap-8 px-4 md:gap-12 lg:px-6">
                  <div className="grid gap-2">
                    {resources.map((res) => (
                      <div key={res.id} className="bg-white dark:bg-gray-800 flex flex-col border shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(45,78,255,0.15)] rounded-lg">
                      <div className="space-y-1.5 p-2">
                        <h3 className="font-bold text-xl">{res.title}</h3>
                        <p className="text-sm text-[#475569] dark:text-[#94a3b8]">
                          Posted on: {res.createdAt.toDate().toLocaleString()}
                        </p>
                      </div>
                      ...
                      {res.link && (
                        <Link href={`https:/${res.link}`} target="_blank" rel="noopener noreferrer" className="p-2 text-blue-500 hover:text-purple-500">
                          {res.link}
                        </Link>
                      )}
                    </div>
